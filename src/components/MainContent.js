				...
				<div className="ui container">
					...
					<div className="ui grid">
						<div className="ten wide column">
							...
							<p className="small">[1] Bonaparte: Live History. In: bonaparte.cc.
						...
						<div className="six wide column">
							<img className="ui fluid image" src="https://upload.wikimedia.org/wikipedia/commons/1/1d/Bonaparte8.jpg" />
							<p className="small"><a href="www.arne-mueseler.de" target="_blank">© Arne Müseler / arne-mueseler.de / CC-BY-SA-3.0</a></p>
						</div>
					</div>
				</div>
			</div>
